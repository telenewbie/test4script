...
# ------------------默认值
DEFAULT_INTERVAL_CPU = 1#5
DEFAULT_INTERVAL_MEM = 1#10
DEFAULT_INTERVAL_PULL_LOG = 1#3600
DEFAULT_INTERVAL_PID =1# 10
DEFAULT_INTERVAL_CHANGE_WIFI =1# 0
DEFAULT_INTERVAL_CHANGE_PCM =1# 7200
DEFAULT_INTERVAL_CHANGE_PCM_CONTINUE =1# 300
DEFAULT_INTERVAL_SAVE_DATA =1# 600
